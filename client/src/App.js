...
const App = () => {
  ...
  const askContractToWhitelist = async () => {
    try {
      ...
      if (ethereum) {
        ...
        console.log("Going to pop wallet now to pay gas...")
        let nftTxn = await connectedContract.whitelistUser();
  ...
  const renderWhitelist = () => (
    <button onClick={askContractToWhitelist} className="cta-button connect-wallet-button">
      Whitelist a User
    </button>
  )
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <p className="header gradient-text">Communities NFT</p>
